              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    ClipRRect(
                        borderRadius: BorderRadius.circular(8.r),
                        child: Image.asset(homeController.homeCategory[index]['image'],fit: BoxFit.cover,width: double.infinity,)),
                    ///overlay
                    Container(
                      decoration: BoxDecoration(
                    ...
                    ///center- title
                    Center(child: Text(homeController.homeCategory[index]['title'],style: AppStyles.titleMedium.copyWith(fontSize: 25.sp,color: Colors.white),))
